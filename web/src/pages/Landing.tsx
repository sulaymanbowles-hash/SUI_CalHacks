  ...
  return (
    <section className="mx-auto max-w-screen-xl px-6 py-16">
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
        {events.map(e => (
          <a key={e.title} className="card group overflow-hidden p-0 transition-transform duration-200 hover:scale-[1.01]">
            ...
            <div className="p-4">
              <div className="font-medium text-[#DCE7F0]">{e.title}</div>
...
export function Landing() {
  return (
    <main className="min-h-screen">
        ...
        <div className="mx-auto grid max-w-screen-xl grid-cols-1 gap-12 px-6 py-24 md:grid-cols-2 md:gap-16">
          ...
          <FadeRise>
            <div className="flex flex-col justify-center">
              ...
              <h1 className="mt-6 font-[Inter_Tight] text-[40px] leading-[1.15] tracking-tight text-[#DCE7F0] sm:text-[56px]">
                Tickets that pay creators on every resale
              </h1>
              <p className="mt-4 max-w-[65ch] text-lg leading-[1.5] text-[var(--muted)]">
                Own your ticket, list it in seconds, and let transfer policies handle royalties automatically.
              </p>
              <div className="mt-8 flex flex-wrap gap-3">
                <Link to="/app">
                  <button className="rounded-xl bg-[#4DA2FF] px-5 py-3 font-medium text-white transition-transform duration-200 ease-out hover:scale-[1.02] active:scale-[0.98]">
                    Get Tickets
                  </button>
                </Link>
                <a href="#how">
      ...
      {/* Marketplace Grid - adds density */}
      <MarketplaceRow />

      {/* How It Works - Asymmetric Editorial */}
      <section id="how" className="mx-auto max-w-screen-xl px-6 py-20">
        <FadeRise>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          {/* Right: two stacked cards with varying lengths */}
          <div className="card">
      ...
      <section id="royalty" className="mx-auto max-w-screen-xl px-6 py-20">
        <FadeRise>
          <div className="mb-12 text-center">
      ...
      <section className="border-t border-white/10 py-20">
        <div className="mx-auto max-w-screen-xl px-6 text-center">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-3">
            <Link to="/app">
              <button className="inline-flex items-center gap-2 rounded-xl bg-[#4DA2FF] px-6 py-3 font-medium text-white transition-transform duration-200 ease-out hover:scale-[1.02]">
                Launch App
